        ...
        artyom.redirectRecognizedTextOutput(function(text,isFinal){
            ...
            if(finish){
                ...
                if(hits>=(arrayText.length*0.9)){
                    ...
                    read.innerHTML="Voce conseguiu a </br>medalha de ouro</br>";
                }else if(hits>=(arrayText.length*0.5)){
                    read.innerHTML="Voce consegiu a </br>medalha de prata</br>";
                }else{
                    read.innerHTML="Voce conseguiu a </br>medalha de bronze</br>";
                }
